...
//    public String cargarDataBase(LocalDate fechaDisponible) throws MiException {
//
...
//
//        profesionalServicio.crearProfesional(null, nombreUsuario, password, password, nombre, apellido, email, fechaNacimiento, dni, especialidad, provincias, localidad, direccion, matricula, diasDisponibles, horarioEntrada, horarioSalida, precioConsulta, fechaDisponible);
//
